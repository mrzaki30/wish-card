                        ...
                        <form wire:submit.prevent="addWish" class="space-y-6">
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        class="absolute right-3 top-3 text-gray-400 group-focus-within:text-purple-500">
                                        👤
                                    </div>
                                </div>
                                @error('name')
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="inline-flex items-center px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium transform hover:scale-105 hover:shadow-lg transition-all duration-200 space-x-2">
                                    <span>Kirim Ucapan</span>
